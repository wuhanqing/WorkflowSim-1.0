...
public class SimulationTest {
    ...
    public static void main(String[] args) {
       ...
       try {
             ...
             */
            String daxPath = "/Users/wuhanqing/Dropbox/Java/WorkflowSim-1.0-master/config/dax/test.xml";
            if(daxPath == null){
    ...
    protected static WorkflowDatacenter createDatacenter(String name) {
        ...
        for (int i = 0; i <= 0; i++) {
            ...
            cpuList.add(cpu);
            int ram = 5; //host memory (MB)
            long storage = 5; //host storage
            int bw = 1000;
            hostList.add(
