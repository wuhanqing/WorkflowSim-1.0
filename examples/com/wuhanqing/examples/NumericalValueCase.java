 ...
 * @date Apr 9, 2013
 */
public class NumericalValueCase {
    ...
    protected static List<CondorVM> createVM(int userId, int vms) {
        ...
        CondorVM[] vm = new CondorVM[vms];
            ...
            vm[0] = new CondorVM(0, userId, 1000, pesNumber, 512, bw, size, vmm, new CloudletSchedulerTimeShared());
            vm[1] = new CondorVM(1, userId, 1500, pesNumber, 768, bw, size, vmm, new CloudletSchedulerTimeShared());
            vm[2] = new CondorVM(2, userId, 2000, pesNumber, 1024, bw, size, vmm, new CloudletSchedulerTimeShared());
            list.add(vm[0]);
            list.add(vm[1]);
            list.add(vm[2]);
        return list;
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            String daxPath = "/Users/wuhanqing/Documents/workflowInstance/Montage_15.xml";
            if(daxPath == null){
