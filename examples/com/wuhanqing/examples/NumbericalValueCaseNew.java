 ...
 * @date Apr 9, 2013
 */
public class NumbericalValueCaseNew {
    ...
    protected static List<CondorVM> createVM(int userId, int vms) {
        ...
        CondorVM[] vm = new CondorVM[vms];
            ...
            vm[0] = new CondorVM(0, userId, 1500, pesNumber, 512, 100, size, vmm, new CloudletSchedulerTimeShared());
            vm[1] = new CondorVM(1, userId, 2000, pesNumber, 768, 150, size, vmm, new CloudletSchedulerTimeShared());
            vm[2] = new CondorVM(2, userId, 2000, pesNumber, 1024, 150, size, vmm, new CloudletSchedulerTimeShared());
            vm[3] = new CondorVM(3, userId, 2500, pesNumber, 1024, 200, size, vmm, new CloudletSchedulerTimeShared());
            vm[4] = new CondorVM(4, userId, 2500, pesNumber, 1024, 200, size, vmm, new CloudletSchedulerTimeShared());
            list.add(vm[0]);
            list.add(vm[1]);
            list.add(vm[2]);
            list.add(vm[3]);
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            String daxPath = "/Users/wuhanqing/Dropbox/Java/WorkflowSim-1.0-master/config/dax/CyberShake_20.xml";
            if(daxPath == null){
...
//             Helper.createVmList(2, 50);
    ...
    protected static WorkflowDatacenter createDatacenter(String name, int hostNum) {
        ...
        hostList = Helper.createCondorHostList1(hostNum);
