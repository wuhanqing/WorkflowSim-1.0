...
//        }
    ...
    public static void main(String[] args) {
       ...
       try {
             ...
             */
            int vmNum = 39;//number of vms;
            /**
             * Should change this based on real physical path
             */
            String daxPath = "/Users/wuhanqing/Dropbox/Java/WorkflowSim-1.0-master/config/dax/Montage_1000.xml";
            if(daxPath == null){
    ...
    protected static WorkflowDatacenter createDatacenter(String name) {
        ...
        //HpProLiantMl110G5_8core  mount = 2.
        for (int i = 0; i <= 0; i++) {
            List<Pe> peList1 = new ArrayList<Pe>();
            int mips = 2660;
            // 3. Create PEs and add these into the list.
            //for a quad-core machine, a list of 4 PEs is required:
            peList1.add(new Pe(Pe.NORMAL,0, new PeProvisionerSimple(mips))); // need to store Pe id and MIPS Rating
            peList1.add(new Pe(Pe.NORMAL,1, new PeProvisionerSimple(mips)));
            ...
            hostList.add(
                    ...
                    cpuList,
                    HostType.Huawei_RH2288,
                    HostType.Huawei_RH2288_W_IDLE,
                    HostType.Huawei_RH2288_W_WORK,
                    HostType.Huawei_RH2288_W_IDLE,
                    HostType.Huawei_RH2288_W_SLEEP,
                    HostType.Huawei_RH2288_W_NAP_PER_PE,
                    hostId,
          ...
          //  hostList.get(i).setW(w);
            
            hostList.get(i).getCpuList().get(0).setPeList(peList1);
            hostId++;

        }
        
        //PlatHomeTRQX150SA_2core  mount = 2.
//        for (int i = 0; i <= 0; i++) {
//            List<Pe> peList1 = new ArrayList<Pe>();
//            int mips = 2500;
//            // 3. Create PEs and add these into the list.
...
//            peList1.add(new Pe(Pe.NORMAL,0, new PeProvisionerSimple(mips))); // need to store Pe id and MIPS Rating
//            peList1.add(new Pe(Pe.NORMAL,1, new PeProvisionerSimple(mips)));
//            peList1.add(new Pe(Pe.NORMAL,2, new PeProvisionerSimple(mips)));
//            peList1.add(new Pe(Pe.NORMAL,3, new PeProvisionerSimple(mips)));
//
//            Cpu cpu = new Cpu(0);
//            List cpuList = new ArrayList<Cpu>();
//            cpuList.add(cpu);
...
//            hostList.add(
//                    new Host(
//                    new PowerModelPlatHomeTRQX150SAXeonL5420(),
//                    cpuList,
//                    HostType.PlatHomeTRQX150SA,
//                    HostType.Acer_AC100_W_IDLE,
//                    HostType.Acer_AC100_W_WORK,
//                    HostType.Acer_AC100_W_IDLE,
//                    HostType.Acer_AC100_W_SLEEP,
//                    HostType.Acer_AC100_W_NAP_PER_PE,
//                    hostId,
//                    new RamProvisionerSimple(ram),
//                    new BwProvisionerSimple(bw),
//                    storage,
...
//        }
        ...
        for (int i = 1; i <= 1; i++) {
            ...
            hostList.add(
                    ...
                    cpuList,
                    HostType.Hitachi_DL2,
                    HostType.Hitachi_DL2_W_IDLE,
                    HostType.Hitachi_DL2_W_WORK,
                    HostType.Hitachi_DL2_W_IDLE,
                    HostType.Hitachi_DL2_W_SLEEP,
                    HostType.Hitachi_DL2_W_NAP_PER_PE,
                    hostId,
                    new RamProvisionerSimple(ram),
                    new BwProvisionerSimple(bw),
                    storage,
        ...
        for (int i = 3; i <= 3; i++) {
            ...
            hostList.add(
                    ...
                    cpuList,
                    HostType.IBM_x3550,
                    HostType.IBM_x3550_W_IDLE,
                    HostType.IBM_x3550_W_WORK,
                    HostType.IBM_x3550_W_IDLE,
                    HostType.IBM_x3550_W_SLEEP,
                    HostType.IBM_x3550_W_NAP_PER_PE,
                    hostId,
                    new RamProvisionerSimple(ram),
                    new BwProvisionerSimple(bw),
                    storage,
        ...
        try {
            ...
            datacenter = new WorkflowDatacenter(hostComsumptionMonitor, name, characteristics, new VmAllocationPolicySimple(hostList), storageList, 0);
