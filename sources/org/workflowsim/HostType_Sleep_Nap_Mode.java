...
public class HostType_Sleep_Nap_Mode
{
	...
	public static final double Acer_AC100_W_NAP_PER_PE = 9.13;
	public static final double Acer_AC100_W_SLEEP = 4.3;
	
	/** 4cores  */
	public static final double Hitachi_DL2_W_WORK = 94.0;
	public static final double Hitachi_DL2_W_IDLE = 45.8;
	public static final double Hitachi_DL2_W_NAP_PER_PE = 12.05;
	public static final double Hitachi_DL2_W_SLEEP = 9.16;
	
	/** 8cores  */
	public static final double Huawei_RH2288_W_WORK = 236;
	public static final double Huawei_RH2288_W_IDLE = 66.8;
	public static final double Huawei_RH2288_W_NAP_PER_PE = 21.15;
	public static final double Huawei_RH2288_W_SLEEP = 13.36;
	
	/** 8cores  */
	public static final double IBM_x3550_W_WORK = 190;
	public static final double IBM_x3550_W_IDLE = 56.5;
	public static final double IBM_x3550_W_NAP_PER_PE = 16.69;
	public static final double IBM_x3550_W_SLEEP = 11.3;
	
	
	private HostType_Sleep_Nap_Mode() {
